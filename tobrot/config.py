...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1167885984:AAEtyMqigdGk983tVKlYK54DAVHZNpFiP7g")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 1510975))
    API_HASH = "b4b328c59b4cf46ac328c0d9e105d0fb"
    ...
    EDIT_SLEEP_TIME_OUT = int(os.environ.get("EDIT_SLEEP_TIME_OUT", 3))
